<template>
                    ...
                    <div class="content-box d-flex align-items-center justify-content-between">
                        <div class="logo">
                            <a href="index.html" class="logo-nav">
                                <img class="img-fluid one" src="/assets/images/konut.png" alt="01 Logo" style="height: 60px; width: 60px; margin-left: 120px;">
                            </a>
  ...
  export default {
    ...
    setup() {
      onMounted(() => {
        // jika ada inisialisasi JS Navbar di main.js template, 
        // Anda bisa panggil fungsi init yang ada di /assets/js/main.js
        // e.g. if (window.initNavbar) window.initNavbar()
      })
    }
  }
  </script>

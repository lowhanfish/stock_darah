            ...
            <q-card class="mdl-md">
                ...
                <form @submit.prevent="addData()">
                    ...
                    <q-card-section class="q-pt-none">
                        ...
                        <q-input v-model="form.deskripsi" type="textarea" outlined square dense
                            class="bg-white margin_btn" /> -->

                        <!-- Isi / Detail Berita -->
                        <span class="h_lable">Isi</span>
                        <q-editor v-model="form.isi" :toolbar="editorToolbar" placeholder="Tulis isi berita..."
                            class="bg-white" />

                        <!-- Lampiran File -->
                        <span class="h_lable">Lampiran File</span>
                        <q-file v-model="form.file_name" label="Pilih File" outlined square dense
                            class="bg-white margin_btn" />
                    ...
                    <q-card-actions class="bg-grey-4 mdl-footer" align="right">
                        <q-btn :loading="btn_add" color="positive" type="submit" label="Simpan" />
